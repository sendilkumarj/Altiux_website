...
$(document).ready(function () {
    ...
    $('.logo-big img, .logo-small img, .mobile-menu a img').on('click', function(e){
        e.preventDefault();
    ...
    var image = $('.home-headder-caurosel');
    var flag = 1;
    setInterval(function() {
        ...
        var txt_flag = flag - 1;
        $('.banner-txt-list li').hide();
        $('.banner-txt-list li:eq('+ txt_flag +')').show();

        //image.css("background", "url('_include/img/slider-images/banner" + flag + ".jpg') 50% 0 no-repeat fixed #fff");
        $('#home-carousel').css("background", "url('_include/img/slider-images/banner" + flag + ".png') 50% 0 no-repeat fixed #d1d2d4");
        image.fadeOut(1, function () {


            image.css("background", "url('_include/img/slider-images/banner" + flag + ".png') 50% 0 no-repeat fixed #d1d2d4");
